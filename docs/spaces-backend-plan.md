...
| **الحالة** | 🚧 **8/17** — الخطوات ١ ([§3.139](log/3.139.md)) و٢ ([§3.140](log/3.140.md)) و٣ ([§3.141](log/3.141.md)) و٤ ([§3.142](log/3.142.md)) و٥ ([§3.143](log/3.143.md)) و٦ ([§3.144](log/3.144.md)) و٧ ([§3.145](log/3.145.md)) و٨ ([§3.146](log/3.146.md)) مغلقة · صفٌّ جديد **٨‑ب** |
...
| ٨‑ب | **تشديد `space_id` إلى `NOT NULL`** — ثلاثة ترحيلات متابعة، بلا backfill جديد · ⚠️ يسبقه حسمُ وحدة الوسائط المولَّدة ([§3.145](log/3.145.md)) | migrations | 🔲 |
