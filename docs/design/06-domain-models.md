...
AR  User        { id (UUIDv7 منصّي — DD‑02), workspace_id, firebase_uid (معرّف خارجي فريد؛ ليس UUID),
                  email: Email, display_name, status: UserStatus, created_at, updated_at, version }
