...
**دَين المرحلة 2 المتبقّي (محوّلات خارجيّة، لا يمسّ `AC`):** `2.8‑ب‑2` (Gemini·Claude·OpenRouter — محجوزةٌ بالمفاتيح) · ~~`DocumentContentResolver`~~ **✅ أُغلق 2026‑08‑01** ([§3.98](log/3.98.md) · [§3.100](log/3.100.md)) · `MediaGenerator` (يفكّ عامل `media`). كلّها **محجوزةٌ بمفاتيحَ أو بيئةٍ حاويّة**، ومعايير القبول لا تتطلّب أيّاً منها.
