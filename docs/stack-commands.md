...
>
> **آخر مطابقةٍ مع الواقع: 2026‑08‑02.**
...
⚠️ **الترتيب مُلزِمٌ على مجرًى جديد: العمّال قبل المُرحّل.** مجموعات المستهلكين تُنشأ عند `$` (ذيل المجرى)، فمجموعةٌ تُنشأ **بعد** أن نشر المُرحّل مدخلاتٍ على مجرًى جديد **لن ترى تلك المدخلات أبداً**. على المجاري القائمة الترتيب غير مؤثّر.
...
الحزمة كاملةً. كلّ وسم `live_*` **يسبر المنفذ ويتخطّى تخطّياً حقيقيّاً** عند غيابه — لا تمريراً مقنّعاً؛ فـ`SKIPPED: no live embedding service reachable` نتيجةٌ صحيحة لا عطل (خدمة التضمين **حاويّةٌ فقط**، فمنفذها 8080 مغلقٌ على المضيف).
