...
| خطُّ الأساس المُوثَّق (`0.5`) | البذرةُ والمولّدُ كلاهما بُني وشُغّل، لكنّ الحافّةَ تحدُّ على عنوان المصدر (`limit_req rate=20r/s`)، فمولّدٌ من مضيفٍ واحدٍ **يقيس الحدَّ لا المنصّة**: عُرض 300.1 طلباً/ث فقُبل 22.0. القرارُ (إعفاءُ العنوان · عناوينُ عدّة · القبولُ بالسقف) قرارُ مالك |
